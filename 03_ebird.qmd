...
Get the number of curlew observations checklists: 

```{r}
f0 <- read_ebd("/media/steffi/0B2747DF04804530/Data Big/Project Data/lb_curlew_distribution/ebd_lobcur_201005_202208_relMay-2023.txt")
nrow(f0)
```
...
How many left?
```{r}
f1 <- read_tsv("Data/Intermediate/ebird_lobcur_obs.txt", guess_max = 100000)
nrow(f1)
```
